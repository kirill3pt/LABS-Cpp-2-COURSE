    ...
    case 2: {
        ...
        do {
            ...
            cout << "\nВведите необходимую операцию: *, /, +, -: " << endl
                << "Для перевода числа из обыкновенной дроби в десятичную - нажмите 1; " << endl
                << "Для перевода из десятичной дроби в обыкновенную - нажмите 2; " << endl
                << "Для сокращения дроби - нажмите 3; " << endl
                << "Для выхода из задания - введите 0. " << endl
                << "\nВвод: ";
            cin >> operation;
            if (operation == '*' || operation == '/' || operation == '+' || operation == '-') {
                cout << "Введите числитель 1 дроби: "; cin >> x0;
                cout << "Введите знаменатель 1 дроби (0 — выход): "; cin >> y0;
                if (y0 == 0) {
                    break;
                }
                cout << "Введите числитель 2 дроби: "; cin >> x1;
                cout << "Введите знаменатель 2 дроби: "; cin >> y1;
